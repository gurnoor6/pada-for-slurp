...
def test_RumorPadaDataset():
    ...
    l = len(data_processor.data[split]['input_str'])
    for i in range(l):
        print(data_processor.data[split]['input_str'][i])
        print(data_processor.data[split]['output_label'][i])
        print(data_processor.data[split]['domain_label'][i])
        print(data_processor.data[split]['drfs'][i])
    exit()
